...
public enum SubstanceProperties {
    ...
    SODIUM_CHLORIDE_LIQUID(0.015075, 2170.0, substances.liquid.SodiumChloride.class, new Color(180, 220, 255, 255)),
    ...
    SODIUM_CHLORIDE_SOLID(0.015075, 2170.0, substances.solid.movableSolid.SodiumChloride.class, new Color(140, 190, 240, 255)),
