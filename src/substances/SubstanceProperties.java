...
public enum SubstanceProperties {
    ...
    COPPER_CHLORIDE_SOLID(0.598, 3390.0, substances.solid.movableSolid.CopperChloride.class, new Color(255, 255, 255, 255)),
    ...
    COPPER_POWDER(398.0, 8940.0, substances.solid.movableSolid.Copper.class, new Color(255, 255, 255, 255)),
    ...
    COPPER_SOLID(398.0, 8940.0, substances.solid.staticSolid.Copper.class, new Color(255, 255, 255, 255)),
