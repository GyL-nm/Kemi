...
public enum SubstanceProperties {
    ...
    SODIUM_CHLORIDE_LIQUID(0.015075, 2170.0, main.substances.liquid.SodiumChloride.class, new Color(112, 173, 237, 255)),
    ...
    SODIUM_CHLORIDE_SOLID(0.015075, 2170.0, main.substances.solid.movableSolid.SodiumChloride.class, new Color(203, 218, 232, 255)),
